...
#     def __init__(self, width=48, height=48, render_mode = None, seed=np.random.randint(0,100)):
#         actions = {
#             "up": K_w
#         }
#         self.random_seed = np.random.RandomState(seed)
...
#         self.score = 0.0
#         self.lives = 1.0
#         game.rng = np.random.RandomState(self.random_seed)
...
#         return self.getGameState(), current_score, done, None
